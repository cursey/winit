...
unsafe fn get_view_class(root_view_class: &'static Class) -> &'static Class {
    ...
    classes.entry(root_view_class).or_insert_with(move || {
        ...
        let is_uiview = msg_send_bool![root_view_class, isSubclassOfClass: uiview_class];
    ...
    unsafe impl WinitUIWindow {
        ...
        fn become_key_window(&self) {
            unsafe {
                ...
                let _: () = msg_send![super(self, UIWindow::class()), becomeKeyWindow];
            }
        }
        ...
        fn resign_key_window(&self) {
            unsafe {
                ...
                let _: () = msg_send![super(self, UIWindow::class()), resignKeyWindow];
            }
        }
    }
);
    ...
    extern "C" fn will_terminate(_: &Object, _: Sel, _: id) {
        unsafe {
            ...
            loop {
                ...
                let is_winit_window = msg_send_bool![window, isKindOfClass: WinitUIWindow::class()];
                if is_winit_window {
