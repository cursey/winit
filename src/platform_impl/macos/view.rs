...
use objc2::foundation::{NSInteger, NSObject, NSUInteger};
    ...
    unsafe impl WinitView {
        ...
        fn init_with_winit(&mut self, state: *mut c_void) -> Option<&mut Self> {
            ...
            this.map(|this| unsafe {
                ...
                let _: () = msg_send![&mut *this, setPostsFrameChangedNotifications: Bool::YES];
    ...
    unsafe impl WinitView {
        ...
        fn view_did_move_to_window(&self) {
            ...
            unsafe {
                ...
                let tracking_rect: NSInteger = msg_send![self,
        ...
        fn draw_rect(&self, rect: NSRect) {
            ...
            unsafe {
                ...
                let superclass = util::superclass(self);
                let _: () = msg_send![super(self, superclass), drawRect: rect];
            }
        }
    ...
    unsafe impl Protocol<NSTextInputClient> for WinitView {
        ...
        fn set_marked_text(
            ...
            unsafe {
                ...
                let has_attr = msg_send_bool![string, isKindOfClass: class!(NSAttributedString)];
                if has_attr {
        ...
        fn do_command_by_selector(&self, _command: Sel) {
            ...
            unsafe {
                ...
                let has_marked_text = msg_send_bool![self, hasMarkedText];
