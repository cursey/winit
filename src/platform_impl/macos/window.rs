...
impl UnownedWindow {
    ...
    pub fn is_visible(&self) -> Option<bool> {
        let is_visible = unsafe { msg_send_bool![*self.ns_window, isVisible] };
        Some(is_visible)
    }
    ...
    pub fn is_resizable(&self) -> bool {
        unsafe { msg_send_bool![*self.ns_window, isResizable] }
    }
    ...
    pub(crate) fn is_zoomed(&self) -> bool {
        ...
        let is_zoomed = unsafe { msg_send_bool![*self.ns_window, isZoomed] };
    ...
    pub fn set_minimized(&self, minimized: bool) {
        let is_minimized = unsafe { msg_send_bool![*self.ns_window, isMiniaturized] };
